#ifndef __svg_SVGPathSegMovetoRel__
#define __svg_SVGPathSegMovetoRel__
...
namespace svg {
	...
	public:
		SVGPathSegMovetoRel() : SVGPathSeg(PATHSEG_MOVETO_REL,'m') {}
...
#endif // __svg_SVGPathSegMovetoRel__
