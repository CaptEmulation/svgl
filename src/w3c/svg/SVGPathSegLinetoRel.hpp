#ifndef __svg_SVGPathSegLinetoRel__
#define __svg_SVGPathSegLinetoRel__
...
namespace svg {
	...
	public:
		SVGPathSegLinetoRel() : SVGPathSeg(PATHSEG_LINETO_REL,'l') {}
...
#endif // __svg_SVGPathSegLinetoRel__
