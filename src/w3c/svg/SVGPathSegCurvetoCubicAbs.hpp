#ifndef __svg_SVGPathSegCurvetoCubicAbs__
#define __svg_SVGPathSegCurvetoCubicAbs__
...
namespace svg {
	...
	public:
		SVGPathSegCurvetoCubicAbs() : SVGPathSeg(PATHSEG_CURVETO_CUBIC_ABS,'C') {}
...
#endif // __svg_SVGPathSegCurvetoCubicAbs__
